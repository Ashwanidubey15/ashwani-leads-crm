...
export default function AssistantsPage() {
  ...
  async function handleCreateAssistant() {
    ...
    try {
      ...
      await fetchAssistants();
      setNewAssistant({ name: "", description: "", firstMessage: "" });
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need to be signed in to manage assistants.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-600">Create and manage your AI assistants with phone number integration.</p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewAssistant({ ...newAssistant, firstMessage: e.target.value })}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  This will be used as the system prompt for your AI assistant. Be detailed about its role, knowledge, and behavior.
                </p>
              </div>
              <div className="text-center">
                <button
                  onClick={handleCreateAssistant}
                  disabled={loading || !newAssistant.name.trim() || !newAssistant.description.trim()}
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              {assistants.length === 0 ? (
                <div className="px-6 py-12 text-center text-gray-500">
                  ...
                  <p className="text-lg font-medium text-gray-900 mb-2">No assistants yet</p>
                  <p className="text-gray-600">Click "Create New Assistant" above to get started.</p>
                </div>
              ) : (
                  ...
                  {assistants.map((assistant) => (
                    <div
                      ...
                      className={`px-6 py-4 cursor-pointer hover:bg-gradient-to-r hover:from-purple-50 hover:to-purple-100 transition-all duration-200 ${
                        selectedAssistant?.id === assistant.id ? 'bg-gradient-to-r from-purple-50 to-purple-100 border-r-2 border-purple-300' : ''
                      }`}
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <h3 className="text-lg font-semibold text-gray-900 truncate">{assistant.name}</h3>
                              <p className="text-sm text-gray-600 mt-1">
                                {assistant.phoneNumbers && assistant.phoneNumbers.length > 0 ? `📞 ${assistant.phoneNumbers[0].number} (${assistant.phoneNumbers[0].label})` : "No phone number assigned"}
                              </p>
            ...
            {selectedAssistant ? (
                ...
                <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-gray-100">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-xl font-semibold text-gray-900">{selectedAssistant.name}</h2>
                        <p className="text-sm text-gray-600">
                          {selectedAssistant.phoneNumbers && selectedAssistant.phoneNumbers.length > 0 ? `📞 ${selectedAssistant.phoneNumbers[0].number} (${selectedAssistant.phoneNumbers[0].label})` : "No phone number assigned"}
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  {isEditing ? (
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <label htmlFor="editFirstMessage" className="block text-sm font-medium text-gray-700 mb-2">
                            First Message (Greeting)
                          </label>
                          <input
                            type="text"
                    ...
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Assistant Details</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                            <label className="block text-sm font-medium text-gray-700 mb-1">Name</label>
                            <p className="text-lg text-gray-900 font-semibold">{selectedAssistant.name}</p>
                          </div>
                          <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                            <label className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                            <p className="text-lg text-gray-900 font-semibold">
                              {selectedAssistant.phoneNumbers && selectedAssistant.phoneNumbers.length > 0 ? `${selectedAssistant.phoneNumbers[0].number} (${selectedAssistant.phoneNumbers[0].label})` : "Not assigned"}
                            </p>
                          </div>
                          <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                          ...
                          <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                            ...
                            <p className="text-lg text-gray-900 font-semibold">
                              {new Date(selectedAssistant.createdAt).toLocaleDateString()}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-gray-200 pt-6">
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Description & Instructions</h3>
                        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-100">
                          <p className="text-gray-700 whitespace-pre-wrap">{selectedAssistant.description}</p>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
                <div className="px-6 py-12 text-center text-gray-500">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Select an Assistant</h3>
                  <p className="text-gray-600">Choose an assistant from the list to view its details and manage it.</p>
                </div>
              </div>
            )}
          </div>
