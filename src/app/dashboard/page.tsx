            ...
            {quickActions.map((action, index) => (
              <Link key={index} href={action.href} className="group">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                  <div className="flex items-center gap-4">
                    <div className={`w-16 h-16 bg-gradient-to-r ${action.color} rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform`}>
                      {action.icon}
                    </div>
                    <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">New phone number purchased</p>
                <p className="text-xs text-gray-500">+1 (555) 123-4567 • 2 hours ago</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">AI Assistant created</p>
                <p className="text-xs text-gray-500">Customer Support Bot • 1 day ago</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Lead qualification call • 2 days ago</p>
              </div>
            </div>
          </div>
        </div>
