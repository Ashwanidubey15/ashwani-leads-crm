...
function SidebarContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="w-72 bg-gradient-to-b from-purple-900 via-purple-800 to-purple-900 border-r border-purple-700 flex flex-col justify-between py-8 px-6 shadow-2xl">
        <div>
          {/* Logo/Brand */}
          <div className="mb-10">
          ...
          <nav className="flex flex-col gap-1">
            ...
            >
              <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                isActive("/") ? "bg-purple-100" : "bg-purple-700"
              }`}>
