...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "POST") {
    const { name, description, firstMessage } = req.body;
    ...
    try {
      ...
      const vapiAssistantId = await createVapiAssistant(name, description, firstMessage || "Hello! How can I help you today?");
